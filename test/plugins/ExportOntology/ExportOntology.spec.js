...
/**
 * Generated by PluginGenerator 2.20.5 from webgme on Fri Jun 10 2022 11:06:38 GMT-0500 (Central Daylight Time).
 */

describe("ExportOntology", function () {
  var testFixture = require("../../globals"),
    gmeConfig = testFixture.getGmeConfig(),
    expect = testFixture.expect,
    logger = testFixture.logger.fork("ExportOntology"),
    PluginCliManager = testFixture.WebGME.PluginCliManager,
    projectName = "testProject",
    pluginName = "ExportOntology",
    project,
    gmeAuth,
    storage,
    commitHash;
